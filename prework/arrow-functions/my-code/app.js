...
// the constructive function objct it self including all of the attrubites and prototypes  
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// window/global oblect 
// 3. Explain why "this" is different when an arrow function is used.
// With normal functions the scoped is bound to the global one by default, arrows functions, which, do not have their own this but they inherit it from the parent scope, in this case the global one.
